...
const LEADERSHIP: LessonMap = {
  principles: {
    ...
    blocks: [
      { type: 'intro', text: 'The strongest managers at {company} are not the busiest people in the room. They are the ones who plan, organize, lead, and control with intent.' },
      ...
      { type: 'keypoints', items: [
        { title: 'Planning', text: 'Set direction and decide what good looks like before the work starts.' },
        { title: 'Organizing', text: 'Match people, tools, and time to the plan so nothing falls through the cracks.' },
        { title: 'Leading', text: 'Motivate and coach. This is the function most managers give the least time to.' },
        { title: 'Controlling', text: 'Measure results against the plan and adjust early, not at the end of the year.' },
      ] },
      { type: 'callout', variant: 'tip', text: 'If every day feels like putting out fires, you are heavy on controlling and light on planning. Rebalance.' },
  ...
  terminology: {
    ...
    blocks: [
      { type: 'intro', text: 'Shared words prevent expensive misunderstandings. These are the terms you will use in nearly every conversation at {company}.' },
      { type: 'keypoints', items: [
        ...
        { title: 'KPI', text: 'A key performance indicator, the number that tells you whether you are on track.' },
        { title: 'One-on-one', text: 'A recurring private conversation that is about the person, not only the tasks.' },
      ] },
      { type: 'callout', variant: 'important', text: 'Accountability is not the same as blame. Holding someone accountable is about clarity of ownership, not fault.' },
  ...
  styles: {
    ...
    subheadline: 'Directive, coaching, and delegating, and when each one lands',
    blocks: [
      { type: 'intro', text: 'The best leaders at {company} adjust their approach to the person and the situation instead of defaulting to one setting.' },
      { type: 'objectives', items: [
      ...
      { type: 'keypoints', items: [
        { title: 'Directive', text: 'High guidance. Right for new hires, a crisis, or work where the stakes are high.' },
        { title: 'Coaching', text: 'Guidance plus questions. Right for capable people who are still growing.' },
        { title: 'Delegating', text: 'Low guidance and high trust. Right for proven performers who want autonomy.' },
      ] },
      { type: 'callout', variant: 'tip', text: 'Managing a strong performer too closely reads as distrust. Leaving a new hire on their own reads as neglect.' },
      { type: 'takeaway', text: 'Style is not who you are. It is a dial you turn to fit the person in front of you.' },
    ],
  },
  communication: {
    ...
    blocks: [
      { type: 'intro', text: 'Vague feedback feels kinder in the moment and is useless by Monday. Precise feedback is the fastest way to help someone at {company} improve.' },
      { type: 'keypoints', items: [
        { title: 'Be specific', text: 'Point to the behavior and the moment, not a personality trait.' },
        { title: 'Lead with impact', text: 'Explain what the behavior caused, so it is clear why it matters.' },
      ...
      { type: 'takeaway', text: 'Specific, timely, and kind beats blunt or vague every time.' },
    ],
  },
  expectations: {
    ...
    blocks: [
      { type: 'intro', text: 'Most performance problems at {company} are really expectations that were never made explicit. Name the standard up front and you prevent the hard conversation later.' },
      { type: 'objectives', items: [
        'Define a clear, observable standard for a role',
        'Separate the outcomes you require from the preferences you can flex on',
        'Confirm the other person actually agrees to it',
      ] },
      { type: 'keypoints', items: [
        { title: 'Make it observable', text: 'An expectation you cannot see or measure cannot be met, or coached.' },
        { title: 'Agree, do not announce', text: 'Expectations land when the person commits, not when you declare them.' },
        { title: 'Reset on change', text: 'New role, new project, new teammate. Set expectations again each time.' },
      ] },
      { type: 'callout', variant: 'tip', text: 'End every kickoff by confirming out loud what success on this work will look like.' },
  ...
  'customer-king': {
    ...
    blocks: [
      { type: 'intro', text: 'Teams at {company} that win keep one question on the table: how does this help the customer? Great managers make that a reflex, not a poster.' },
      { type: 'keypoints', items: [
        { title: 'Connect the work', text: 'Show each person how their task reaches a real customer.' },
        { title: 'Bring the voice in', text: 'Share actual customer quotes and complaints, not only dashboards.' },
        { title: 'Protect the promise', text: 'When trade-offs appear, weigh them against the customer commitment.' },
      ] },
      { type: 'callout', variant: 'important', text: 'A culture that puts customers first is built in the hard trade-offs. That is when your team learns what you truly value.' },
      { type: 'takeaway', text: 'When the customer wins, the metrics usually follow.' },
    ],
  },
}
...
const ONBOARDING: LessonMap = {
  principles: {
    ...
    blocks: [
      { type: 'intro', text: 'Your first month at {company} is about learning how value gets created here, not about proving you already know everything.' },
      { type: 'objectives', items: [
      ...
      { type: 'keypoints', items: [
        { title: 'Learn before changing', text: 'Understand why things work the way they do before you try to improve them.' },
        { title: 'Ask early', text: 'Questions in week one are expected. In week ten they are expensive.' },
        { title: 'Find your people', text: 'Your onboarding buddy and your teammates are your fastest path to answers.' },
      ] },
      { type: 'callout', variant: 'tip', text: 'Keep a running list of your questions. Patterns in it show where the organization is confusing, which is useful feedback later.' },
      { type: 'takeaway', text: 'You ramp fastest by staying curious, not by looking busy.' },
    ],
  },
  terminology: {
    headline: 'Who’s Who and Key Terms',
    subheadline: 'The names and words you will hear on day one',
    blocks: [
      { type: 'intro', text: 'Every workplace has its own shorthand. Learning the shorthand at {company} early saves you from nodding along to things you do not follow.' },
      { type: 'keypoints', items: [
        { title: 'Your team', text: 'The people you will work with daily. Learn their names and what each one owns.' },
        { title: 'Cross-functional partners', text: 'The teams you will depend on, and who to go to for what.' },
        { title: 'Core systems', text: 'The handful of tools where the real work happens.' },
      ] },
      { type: 'callout', variant: 'important', text: 'When you hear an acronym you do not know, ask. Everyone did in their first week too.' },
      { type: 'takeaway', text: 'Knowing who does what turns a maze into a map.' },
    ],
  },
  styles: {
    headline: 'Tools and Systems',
    subheadline: 'Where the work actually happens',
    blocks: [
      { type: 'intro', text: 'You do not need to master every tool at {company}. You need the few you will touch daily, and you need to know where to look when you are stuck.' },
      { type: 'objectives', items: [
        'Log into and navigate your core systems',
        'Know where documentation and help live',
        'Complete a real task from start to finish',
      ] },
      { type: 'keypoints', items: [
        { title: 'Start narrow', text: 'Learn the small set of features you will use most of the time.' },
        { title: 'Bookmark the help', text: 'Know the wiki, the support channel, and who to tag.' },
        { title: 'Do it live', text: 'You learn a system by completing a real task in it, not by watching a demo.' },
      ] },
      { type: 'callout', variant: 'tip', text: 'Cannot find the right system? Check the team wiki first, then ask your buddy. That order saves everyone time.' },
      { type: 'takeaway', text: 'Confidence with the tools is mostly repetition, and it comes fast.' },
    ],
  },
  communication: {
    headline: 'Culture and Values',
    subheadline: 'How things really get done here',
    blocks: [
      { type: 'intro', text: 'Culture at {company} is the unwritten sense of how we do things. Reading it early helps you fit in without losing what makes you effective.' },
      { type: 'keypoints', items: [
        { title: 'Watch the norms', text: 'How people meet, message, and disagree tells you what is valued.' },
        { title: 'Match the channel', text: 'Know when to use chat, email, or a quick call. Each one carries different weight.' },
        { title: 'Assume good intent', text: 'Most friction early on is a gap in norms, not a problem with people.' },
      ] },
      { type: 'callout', variant: 'important', text: 'When you are invited to something you do not understand, ask what your role in it should be. That beats guessing or declining.' },
  ...
  expectations: {
    ...
    blocks: [
      { type: 'intro', text: 'Clarity beats guesswork. Knowing exactly what {company} expects of you removes the anxiety of wondering whether you are doing it right.' },
      { type: 'objectives', items: [
        'Name your two or three most important outcomes',
        'Know how your work will be measured',
        'Understand what great looks like in ninety days',
      ] },
      { type: 'keypoints', items: [
        { title: 'Outcomes over activity', text: 'You are measured on results, not on hours or how busy you look.' },
        { title: 'Confirm the priorities', text: 'Ask your manager to rank them so you focus on what matters.' },
        { title: 'Grow in stages', text: 'Expectations build across your first ninety days. Early is about learning, later is about owning.' },
      ] },
      { type: 'callout', variant: 'tip', text: 'In your next one-on-one, ask what a great first ninety days looks like to your manager. Then write it down.' },
      { type: 'takeaway', text: 'When you know the target, hitting it gets much simpler.' },
    ],
  },
  'customer-king': {
    ...
    blocks: [
      { type: 'intro', text: 'Even if you never speak with a customer directly, your work at {company} reaches one. Seeing that line makes the job matter more.' },
      { type: 'keypoints', items: [
        { title: 'Trace your impact', text: 'Follow your work downstream until it touches a real customer.' },
        { title: 'Represent them', text: 'In meetings, be the person who asks what the customer would think.' },
        { title: 'Small things add up', text: 'The quality of your piece becomes part of the customer’s whole experience.' },
      ] },
...
const COMPLIANCE: LessonMap = {
  principles: {
    ...
    blocks: [
      { type: 'intro', text: 'Compliance at {company} exists to protect people, customers, and the business. It is not there to slow you down or generate forms.' },
      { type: 'objectives', items: [
        'Explain the real purpose of a compliance program',
        'Recognize your personal role in it',
        'Understand why not knowing a rule is never a defense',
      ] },
      { type: 'keypoints', items: [
        { title: 'It protects people', text: 'Rules usually exist because someone, somewhere, got hurt without them.' },
        { title: 'It is everyone’s job', text: 'Compliance is not a department. It is a daily habit for every employee.' },
        { title: 'It builds trust', text: 'Customers and regulators stay because {company} does the right thing consistently.' },
      ] },
      { type: 'callout', variant: 'important', text: 'When a rule seems pointless, ask why it exists before you work around it. There is usually a costly story behind it.' },
  ...
  terminology: {
    ...
    blocks: [
      ...
      { type: 'keypoints', items: [
        { title: 'PII', text: 'Personally identifiable information, meaning data that can identify a specific person.' },
        { title: 'Conflict of interest', text: 'When a personal interest could improperly sway a work decision.' },
      ...
      { type: 'callout', variant: 'tip', text: 'Not sure whether something is PII? Treat it as if it is until you confirm otherwise.' },
      { type: 'takeaway', text: 'The right word signals that you understand the risk, and how to handle it.' },
    ],
  },
  styles: {
    ...
    blocks: [
      { type: 'intro', text: 'You do not need to be a lawyer. You need to recognize which situations at {company} trigger which obligations.' },
      { type: 'objectives', items: [
      ...
      { type: 'keypoints', items: [
        { title: 'Know the triggers', text: 'It is less about memorizing rules and more about spotting when one applies.' },
        { title: 'When in doubt, pause', text: 'A five minute check beats a violation you cannot undo.' },
        { title: 'Document as you go', text: 'A clear record protects you and shows a good faith effort.' },
      ] },
      { type: 'callout', variant: 'important', text: 'Regulations change. What was fine last year may not be fine today, so rely on current guidance rather than memory.' },
      { type: 'takeaway', text: 'Spotting the trigger is most of what it takes to stay compliant.' },
    ],
  },
  communication: {
    ...
    blocks: [
      { type: 'intro', text: 'A concern raised early is a problem prevented. {company} needs people who report in good faith, and it protects them when they do.' },
      { type: 'keypoints', items: [
        { title: 'Report when in doubt', text: 'You do not need proof. A genuine concern is enough to raise.' },
        { title: 'Use the channel', text: 'Go through the proper reporting path, not the rumor mill.' },
        { title: 'Protection is real', text: 'Retaliation against a good faith reporter is itself a serious violation.' },
      ] },
      { type: 'callout', variant: 'important', text: 'Seeing something wrong and staying silent can make you part of the problem. Reporting is the responsible move.' },
  ...
  expectations: {
    ...
    blocks: [
      ...
      { type: 'objectives', items: [
        ...
        'Preserve information instead of quietly fixing it',
        'Escalate to the right people without delay',
      ] },
      { type: 'keypoints', items: [
        { title: 'Contain, do not cover', text: 'Stop the harm. Never hide or alter what happened.' },
  ...
  'customer-king': {
    ...
    blocks: [
      ...
      { type: 'callout', variant: 'tip', text: 'A colleague sharing customer data over personal email is a moment to report, not a moment to look the other way.' },
...
const SALES: LessonMap = {
  principles: {
    ...
    blocks: [
      ...
      { type: 'callout', variant: 'tip', text: 'If you are talking more than you are listening on a first call, you are selling too early.' },
      { type: 'takeaway', text: 'Understand the problem deeply and the solution starts to sell itself.' },
    ],
  },
  terminology: {
    ...
    blocks: [
      { type: 'intro', text: 'You cannot sell what you cannot explain simply. Knowing the {company} offering cold lets you translate features into customer value on the spot.' },
      { type: 'keypoints', items: [
        ...
        { title: 'Proof on hand', text: 'Have a story or a number ready for each key claim.' },
      ] },
      { type: 'callout', variant: 'important', text: 'A confused prospect never buys. If you cannot explain it simply, you do not know it well enough yet.' },
  ...
  styles: {
    ...
    blocks: [
      { type: 'intro', text: 'Discovery is where deals at {company} are really won. Great questions surface needs the customer had not put into words.' },
      { type: 'objectives', items: [
        'Ask open questions that start a real conversation',
        'Uncover the cost of the customer’s status quo',
        'Listen for what is said and what is avoided',
      ] },
      { type: 'keypoints', items: [
        { title: 'Open, not yes or no', text: 'Ask questions that cannot be answered in a single word.' },
        { title: 'Quantify the pain', text: 'Help the customer put a number on what the problem costs.' },
        { title: 'Silence is a tool', text: 'After a good question, wait. The best answers come in the pause.' },
      ] },
      { type: 'callout', variant: 'tip', text: 'The best discovery questions are open and about their goals, not about your product.' },
      { type: 'takeaway', text: 'The person who asks the best questions guides the conversation.' },
    ],
  },
  communication: {
    headline: 'Handling Objections',
    subheadline: 'Turn a no into tell me more',
    blocks: [
      { type: 'intro', text: 'Objections are not rejection. They are requests for information. Top reps at {company} lean in instead of flinching.' },
      { type: 'keypoints', items: [
        { title: 'Get curious', text: 'Ask what is behind the objection before you answer it.' },
        { title: 'Do not discount by reflex', text: 'A price objection is often about value, not the number.' },
        { title: 'Acknowledge, then address', text: 'Show that you heard them before you respond.' },
      ] },
      { type: 'callout', variant: 'important', text: 'When a customer says it is too expensive, ask what they are comparing it to. The answer reframes the whole conversation.' },
  ...
  expectations: {
    ...
    blocks: [
      { type: 'intro', text: 'The top reps at {company} are not lucky. They run a disciplined process and hold themselves to it every week.' },
      { type: 'objectives', items: [
      ...
      { type: 'keypoints', items: [
        ...
        { title: 'Create a reason', text: 'Give the prospect something valuable to come back for.' },
        { title: 'Run the process', text: 'Consistency beats heroics. Trust the steps.' },
      ] },
      { type: 'callout', variant: 'tip', text: 'Never end a call without the next one booked. A vague promise to follow up is where deals go to die.' },
      { type: 'takeaway', text: 'Great selling is a discipline you repeat, not a talent you are born with.' },
    ],
  },
  'customer-king': {
    ...
    blocks: [
      { type: 'intro', text: 'A great process at {company} deserves a clear ask. Closing is not pressure. It is helping the customer make the decision they came for.' },
      { type: 'keypoints', items: [
        { title: 'Earn the close', text: 'If you have done discovery well, the close is a natural next step.' },
        { title: 'Ask directly', text: 'State the next step plainly instead of hoping they raise it.' },
        { title: 'Silence after the ask', text: 'Make the request, then let them answer. Do not talk past it.' },
      ] },
      ...
      { type: 'takeaway', text: 'If you have helped them all the way here, asking for the business is a service.' },
    ],
  },
}
...
function activityLesson(kind: 'practice' | 'milestone' | 'verify', title: string): NodeLesson {
  if (kind === 'practice')
    return {
      ...
      blocks: [
        { type: 'intro', text: 'Short, realistic scenarios put the concepts to work, because you learn a skill by using it, not by reading about it.' },
        { type: 'keypoints', items: [
          { title: 'Decide fast', text: 'Each scenario asks you to choose the best next move.' },
          { title: 'See the why', text: 'You get instant feedback on what worked and what did not.' },
  ...
  if (kind === 'milestone')
    return {
      ...
      blocks: [
        ...
        { type: 'takeaway', text: 'Checkpoints keep the path honest. You advance because you are ready.' },
      ],
    }
  return {
    headline: title,
    ...
    blocks: [
      ...
      { type: 'keypoints', items: [
        { title: 'Skill, verified', text: 'You demonstrate the ability, and the system records it as proven.' },
...
const QUIZZES: Record<string, Record<string, LessonQuiz>> = {
  ...
  compliance: {
    ...
    communication: Q('You should report a concern when…', 'You have a genuine, good-faith concern', 'Only with hard proof', 'Never, since it is not your job'),
